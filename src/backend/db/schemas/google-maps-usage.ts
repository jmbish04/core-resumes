...
export const GOOGLE_MAPS_USAGE_TABLE_DESCRIPTION = "Append-only log tracking every usage event of Google Maps APIs to ensure we stay within the $200 free tier.";
