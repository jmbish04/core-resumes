...
export const roleResumeBulletsMap = sqliteTable(
  "role_resume_bullets_map",
  {
    id: integer("id").primaryKey({ autoIncrement: true }),
    resumeBulletId: integer("resume_bullet_id")
      .notNull()
      .references(() => roleResumeBullets.id, { onDelete: "cascade" }),
