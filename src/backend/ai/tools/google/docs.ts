...
export class GoogleDocsClient {
   ...
   */
  async getRawDocument(docIdInput: string): Promise<GoogleDocument> {
    const docId = extractGoogleId(docIdInput);
    return this.docsFetch<GoogleDocument>(`/documents/${docId}`);
  }
   ...
   * Exposing this gives LLM agents full control over the Google Docs API.
   */
