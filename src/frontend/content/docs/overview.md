...
- [Discovery Board Aggregator (Pipeline A)](/docs/discovery-board-aggregator) — Upstream discovery and synchronization system for finding new company job boards
- [Active Board Tracker (Pipeline B)](/docs/active-board-tracker) — Automated job scanning, snapshotting, trend analysis, and active pipeline configuration
...
- [Job Boards (Greenhouse, Ashby, Lever)](/docs/integrations/job-boards) — Public API job scrape fallback, company board tokens, and ATS-specific endpoint structures
