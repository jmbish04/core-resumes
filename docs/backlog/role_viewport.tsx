...
const CollapsibleCard = ({ title, icon: Icon, children, defaultOpen = true, titleRight }) => {
  ...
  return (
    <Card className="w-full mb-4 border-slate-800 bg-slate-900 overflow-hidden transition-all duration-300 shadow-md">
      ...
      >
        ...
        {/* Center Aligned Header as requested */}
        <div className="w-full px-12 text-center flex justify-center items-center">
          <h3 className="font-semibold text-[var(--foreground)] text-lg truncate">{title}</h3>
        </div>

        <div className="absolute right-5 flex items-center gap-4">
          {titleRight && (
            <span className="font-bold text-[var(--chart-1)] whitespace-nowrap hidden sm:block">
              {titleRight}
            </span>
          )}
      ...
      {/* Left Aligned Text Heavy Portion as requested */}
      {isOpen && (
...
{ "qaPairs": [ { "interviewer": "...", "justin": "...", "insight": "Why this response works" } ] }`;
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen font-sans antialiased selection:bg-[var(--chart-1)] selection:text-white text-left">
      ...
      {/* Sidebar */}
      <aside
        className={`${isMobileMenuOpen ? "block" : "hidden"} md:flex w-full md:w-64 bg-[var(--background)] border-r border-[var(--border)] flex-col shadow-xl z-20 flex-shrink-0 absolute md:static h-[calc(100vh-65px)] md:h-screen overflow-y-auto`}
      >
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto overflow-x-hidden w-full h-[calc(100vh-65px)] md:h-screen relative bg-[var(--background)]">
        <div className="max-w-4xl mx-auto animate-in fade-in duration-500 pb-20 p-4 md:p-8 lg:p-12">
            ...
            <div className="space-y-6">
              <div className="mb-6">
                ...
                <p className="text-lg text-[var(--muted-foreground)] leading-relaxed">
                  ...
                  generating fit metrics, gap analysis, a targeted resume, cover letter, and a mock
          ...
          {/* SECTION: AI JOB INFO & ALIGNMENT */}
          {activeTab === "ai-job-info" && aiJobInfo && aiRoleAnalysis && (
            <div className="space-y-6 animate-in slide-in-from-bottom-4 relative">
              {/* STICKY HEADER AND TOP CARDS - Vertically stacked, horizontal interior */}
              <div className="sticky top-0 z-40 bg-[var(--background)] pt-2 pb-6 border-b border-[var(--border)] shadow-sm">
                <h2 className="text-3xl font-extrabold text-[var(--foreground)] tracking-tight mb-4 flex items-center">
                  <Building2 className="mr-3 text-[var(--chart-1)] h-8 w-8" /> Job Breakdown &
                  Alignment
                </h2>

                <div className="flex flex-col space-y-4">
                  {/* Score Card - Horizontal layout vertically stacked */}
                  <CollapsibleCard
                    title="Overall Fit Score"
                    icon={Target}
                    titleRight={`${aiRoleAnalysis.fitScore}/100 Match`}
                    defaultOpen={true}
                  >
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      <div className="w-full md:w-1/3 aspect-square max-h-[220px]">
                                    ...
                                    return (
                                      <text x={viewBox.cx} y={viewBox.cy} textAnchor="middle">
                                        <tspan
                                          x={viewBox.cx}
                                          y={(viewBox.cy || 0) - 10}
                                          className="fill-[var(--foreground)] text-4xl font-bold"
                                        >
                      ...
                      <div className="w-full md:w-2/3 flex flex-col justify-center">
                        <div className="flex items-center gap-2 leading-none font-bold text-[var(--chart-1)] mb-3 text-lg">
                          <Sparkles className="h-5 w-5" /> AI Rationale
                        </div>
                        <div className="leading-relaxed text-[var(--foreground)] text-base">
                  ...
                  <CollapsibleCard
                    ...
                    icon={MapPin}
                    titleRight={`Rating: ${aiJobInfo.locationAnalysis?.rating}/10`}
                    defaultOpen={false}
                  >
                  ...
                  <CollapsibleCard
                    ...
                    icon={DollarSign}
                    titleRight={aiJobInfo.compensationAnalysis?.negotiationTarget}
                    defaultOpen={false}
                  >
              ...
              {/* Scrollable body under sticky header - using stacked CollapsibleCards */}
            ...
            <div className="space-y-6 animate-in fade-in">
              <div className="mb-6">
                ...
                <p className="text-lg text-[var(--muted-foreground)] leading-relaxed max-w-3xl">
                  This dashboard synthesizes Justin Bishop's 12+ year career at Google, transforming
                  qualitative performance reviews and project outcomes into quantifiable data. It
                  highlights his unique superpower: bridging the gap between Legal, Engineering, and
                  Business.
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-4">
                ...
                >
                  <div className="text-left pt-2">
                    ...
                    <p className="text-[var(--muted-foreground)] leading-relaxed">
                      Generated massive cost reductions by identifying legacy waste, replacing rigid
                      policies with dynamic, automated preservation workflows, and eliminating
                      thousands of unnecessary holds.
                    </p>
                  </div>
                </CollapsibleCard>

                <CollapsibleCard
                  title="Adoption Increase"
                  icon={Zap}
                  titleRight="300%"
                  defaultOpen={false}
                >
                  <div className="text-left pt-2">
                    ...
                    <p className="text-[var(--muted-foreground)] leading-relaxed">
                      Transformed fragmented legal processes into unified, user-first tools
                      (BumbleBee, DOTS). By focusing on user pain points rather than top-down
                      mandates, adoption tripled within 18 months.
                    </p>
                  </div>
                </CollapsibleCard>
                ...
                >
                  <div className="text-left pt-2">
                    ...
                    <p className="text-[var(--muted-foreground)] leading-relaxed">
                      Cut manual data assembly and onboarding time significantly by engineering
                      centralized intake pipelines and automated dashboards across various legal
                      practice groups.
                    </p>
                  </div>
                </CollapsibleCard>
          ...
          {activeTab === "alignment" && (
            <div className="space-y-6 animate-in fade-in p-4 md:p-8 lg:p-12">
              <div className="mb-6">
                <h2 className="text-3xl font-extrabold text-[var(--foreground)] tracking-tight mb-3">
                  ...
                  <div className="w-full lg:w-1/2 space-y-8">
                    ...
                    <div className="flex gap-5 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-base text-[var(--muted-foreground)] leading-relaxed text-left">
                          Expertise lies in translating stakeholder ambiguity into technical specs,
                          executing AI integration, and validating data pipelines.
                        </p>
                      </div>
                    </div>
                    <div className="bg-[var(--background)] p-6 rounded-xl border border-[var(--border)] mt-6 shadow-sm">
                      ...
                      <p className="leading-relaxed text-[var(--foreground)] text-base text-left italic">
                        "He never had a formal engineering title, but he delivered like one... half
                        the historical infrastructure has his name on it." Transitioning to a Data
                        or Product Leadership role formalizes this established trajectory.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="space-y-6 animate-in fade-in p-4 md:p-8 lg:p-12">
              <div className="mb-6">
                ...
                <p className="text-lg text-[var(--muted-foreground)] leading-relaxed max-w-3xl">
                  ...
                  deliver massive ROI, drive platform adoption, and engineer solutions that replace
                  legacy complexity with scalable clarity.
                </p>
              </div>
              ...
              <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex flex-col gap-6 py-4">
                    ...
                    <div className="bg-[var(--background)] p-6 rounded-xl border border-[var(--border)] mt-4">
                      ...
                      <p className="leading-relaxed text-[var(--foreground)] text-base text-left">
                        ...
                        outsized returns across hardware infrastructure, enterprise legal management
                        platforms, and core discovery revenue streams.
                      </p>
                    </div>
                  </div>
                </CollapsibleCard>
                ...
                >
                  <p className="text-base text-[var(--foreground)] leading-relaxed text-left py-2">
                    ...
                    detection and cost modeling, shifting the department from reactive reporting to
                    proactive insights.
                  </p>
                </CollapsibleCard>
                  ...
                  >
                    <div className="py-4">
                      ...
                      <div className="space-y-8">
                        ...
                        <div>
                          <h4 className="text-base font-bold text-[var(--foreground)] mb-2 flex items-center">
                            <Target className="w-5 h-5 mr-3 text-[var(--chart-1)]" /> The Constraint
                          </h4>
                          <p className="text-[var(--muted-foreground)] text-base leading-relaxed ml-8">
                            {step.constraint}
                          </p>
