/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 44d16e116df4322bb055a7ab695fc0c3)
// Runtime types generated with workerd@1.20260515.1 2026-03-09 nodejs_compat
interface __BaseEnv_Env {
  ...
  NOTEBOOKLM_MCP_AGENT: DurableObjectNamespace<
    import("./dist/_worker.js/index").NotebookLMMcpAgent
  >;
  ...
  SYNC_BROADCAST_AGENT: DurableObjectNamespace<
    import("./dist/_worker.js/index").SyncBroadcastAgent
  >;
  ROLE_CHAT_AGENT: DurableObjectNamespace<import("./dist/_worker.js/index").RoleChatAgent>;
  ROLE_ASSETS_WORKFLOW: Workflow<
    Parameters<import("./dist/_worker.js/index").RoleAssetsWorkflow["run"]>[0]["payload"]
  >;
  ROLE_ANALYSIS_WORKFLOW: Workflow<
    Parameters<import("./dist/_worker.js/index").RoleAnalysisWorkflow["run"]>[0]["payload"]
  >;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "BUCKET_NAME_AUDIO"
      | "BUCKET_NAME_FILES"
      | "ROLE_PODCAST_POLL_INTERVAL"
      | "ROLE_PODCAST_MAX_POLLS"
      | "ROLE_PODCAST_SOURCE_WAIT_SECS"
      | "GREENHOUSE_API_BASE"
