...
CREATE INDEX IF NOT EXISTS `email_parties_email_id_idx` ON `email_parties` (`email_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `email_parties_domain_idx` ON `email_parties` (`domain`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `email_parties_is_self_idx` ON `email_parties` (`is_self`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `email_attachments_email_id_idx` ON `email_attachments` (`email_id`);--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS `emails_role_id_idx` ON `emails` (`role_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `emails_sender_domain_idx` ON `emails` (`sender_domain`);--> statement-breakpoint
